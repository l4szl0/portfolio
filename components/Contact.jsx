        ...
        <div className="grid lg:grid-cols-5 gap-8">
          <div className="col-span-3 lg:col-span-2 w-full h-full shadow-xl shadow-gray-600 rounded-xl p-4">
            <div className="lg:p-4 h-full">
              ...
              <div className="py-4">
                <h2 className="py-4 text-center">Török László</h2>
          ...
          <div className="col-span-3 w-full h-full shadow-xl shadow-gray-600 rounded-xl p-4">
            <div className="p-4">
                <form>
                    ...
                    <div className="flex flex-col py-2">
                        ...
                        <input className="border-2 rounded-lg p-3 flex border-gray-400" type="eamil" />
                    </div>
                    <div className="flex flex-col py-2">
                    ...
                    <button className="w-full p-4 text-gray-300 mt-4">Send Message</button>
                </form>
            </div>
          </div>
        </div>
